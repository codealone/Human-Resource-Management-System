...
public class Registration extends JFrame implements ActionListener, FocusListener {
	...
	public JPanel createPage5()
	{
		...
		btn4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (n1.equals("")) {
					...
					DisplayContact dc = new DisplayContact(n1);
		...
		btn3.setBounds(300, 350, 200, 30);
		btn4.setBounds(300, 390, 200, 30);
